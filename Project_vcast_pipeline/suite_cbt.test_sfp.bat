...
manage -p Project --import ENV_MONITORED_C.vce -lc
manage -p Project --level GNU_C_49/C_SUITE --add ENV_MONITORED_C
...
vpython vc_scripts/managewait.py --wait_time 30 --wait_loops 1 --command_line "--project "%WORKING_DIR%\Project.vcm"  --level GNU_C_49/C_SUITE -e ENV_MONITORED_C --build-execute --incremental --output GNU_C_49_C_SUITE_ENV_MONITORED_C_rebuild.html" >> unstashed_build.log
